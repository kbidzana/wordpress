...
function elite_optionsframework_options_page() {
    ...
    <div class="trail-notify">
        <h1>Get Elite Theme PRO!</h1>
        <p style="font-size:15px; line-height: 20px;"><?php _e('You are using the Lite Version of Elite Theme. Upgrade to Pro for extra features like Home Page Slider Contact Page, Gallery Features, Portfolio Page Template, FullWidth Page Templates, Multiple Color Options and much more.','elite'); ?></p>
        <a href="http://www.inkthemes.com/wp-themes/elite-pro-wordpress-theme/" target="blank"><?php _e('Upgrade to Elite PRO Theme here','elite'); ?> >></a>
    </div>
    <div class="wrap" id="of_container">
        <div id="of-popup-save" class="of-save-popup">
            <div class="of-save-save"><?php _e('Options Updated', 'elite'); ?></div>
        </div>
        <div id="of-popup-reset" class="of-save-popup">
            <div class="of-save-reset"><?php _e('Options Reset', 'elite'); ?></div>
        </div>
...
function elite_optionsframework_uploader_function($id, $std, $mod) {
    ...
    if ($mod != 'min') {
        $val = $std;
        if (elite_get_option($id) != "") {
            $val = elite_get_option($id);
        }
